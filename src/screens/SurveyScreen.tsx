  ...
  return (
    <View style={styles.container}>
      ...
      {formik.errors.annualIncome && (
        <ErrorMessage message={formik.errors.annualIncome as string} />
      )}
      <TextInput
        label="Credit Score"
        keyboardType="numeric"
      ...
      {formik.errors.creditScore && (
        <ErrorMessage message={formik.errors.creditScore as string} />
      )}
      ...
      {formik.errors.preferredRewards && (
        <ErrorMessage message={formik.errors.preferredRewards as string} />
      )}
